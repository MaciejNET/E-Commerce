...
internal sealed class ProductRepository : IProductRepository
{
    ...
    public Task<bool> ExistsAsync(string sku)
        => _context.Products.AnyAsync(x => x.Sku == sku);

    public async Task<IEnumerable<Product>> BrowseAsync(string searchText, Guid? categoryId, decimal? minPrice, decimal? maxPrice)
    {
