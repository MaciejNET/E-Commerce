...
using ECommerce.Modules.Reviews.Core.Exceptions;
using ECommerce.Modules.Reviews.Core.Repositories;
using ECommerce.Modules.Reviews.Core.Services;
using ECommerce.Modules.Reviews.UnitTests.Time;
using ECommerce.Shared.Abstractions.Time;
using FluentAssertions;
using Moq;

namespace ECommerce.Modules.Reviews.UnitTests.Services;
...
public class ReviewServiceTests
{
    ...
    public async Task AddAsync_GivenUserDoesNotPlacedReview_ShouldAddReviewSuccessfully()
    {
        ...
        reviewRepositoryMock.Verify(x => x.ExistsForProduct(reviewDetailsDto.ProductId, reviewDetailsDto.Email), Times.Once);
        reviewRepositoryMock.Verify(x => x.ExistsForProduct(reviewDetailsDto.ProductId, reviewDetailsDto.UserId.Value), Times.Once);
